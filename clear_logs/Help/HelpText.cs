...
namespace ClearLogs.Help
{
    ...
    public class HelpText
    {
        ...
        /// </param>
        /// <param name="options">
        ///     The instance that collected command line arguments parsed with <see cref="CommandLineParser" />
        ///     class.
        /// </param>
        ...
        ///     empty strings.
        /// </exception>
        private HelpText(string heading, object options)
            : this()
        {
            Heading = heading;
            AddOptions(options);
        ...
        private StringBuilder PreOptionsHelp { get; }
        private StringBuilder OptionsHelp { get; set; }
        private StringBuilder PostOptionsHelp { get; }
        ...
        {
            get => _maximumDisplayWidth.HasValue ? _maximumDisplayWidth.Value : DefaultMaximumLength;
        ...
        private BaseSentenceBuilder SentenceBuilder { get; }
        ...
        /// </summary>
        /// <param name="options">
        ///     The instance that collected command line arguments parsed with the
        ...
        public void AddOptions(object options, string requiredWord, int maximumLength)
        {
            ...
            if (optionHelp != null) optionList.Add(optionHelp);
            ...
            foreach (var option in optionList) AddOption(requiredWord, maxLength, option, remainingSpace);
        }
        ...
        /// </summary>
        /// <param name="options">
        ///     An options target <see cref="CommandLineOptionsBase" /> instance that collected command line arguments parsed with
        ...
        {
            if (options == null) throw new ArgumentNullException("options");
            if (options.InternalLastPostParsingState.Errors.Count == 0) return string.Empty;
        ...
        private void AddOption(string requiredWord, int maxLength, BaseOptionAttribute option, int widthOfHelpText)
        {
            ...
            {
                if (AddDashesToOption) optionName.Append('-');
            ...
            if (!string.IsNullOrWhiteSpace(option.HelpText))
                ...
                {
                    var wordBuffer = 0;
                    var words = option.HelpText.Split(' ');
        ...
        private static void AddLine(StringBuilder builder, string value, int maximumLength)
        {
            ...
            do
            {
                ...
                if (value.Length > 0) builder.Append(Environment.NewLine);
        ...
        private int GetMaxLength(IEnumerable<BaseOptionAttribute> optionList)
        {
            ...
            foreach (var option in optionList)
            {
                ...
                if (hasShort && hasLong) optionLength += 2;
